...
public class TestEmpDao {
	...
	public void testInsertMany() throws SQLException {
		...
		for (int i = 1; i < 20; i++) {
			...
			Emp emp = new Emp("rose"+ i, "rose" + i, "123456", "jack@163.com", "13012345678", 3600, Date.valueOf("1995-10-21"),
	...
	@Test
	public void testUpdatePwd(Emp emp) throws SQLException {
	...
	@Test
	public void testEmpPic() throws SQLException {
